	...
	function Wysiwyg() {
		...
		this.controls = {
			...
			h1: {
				...
				visible: true,
				className: "h1",
				command: ($.browser.msie || $.browser.opera || $.browser.webkit ) ? "FormatBlock" : "heading",
				"arguments": ($.browser.msie || $.browser.opera || $.browser.webkit) ? "<h1>" : "h1",
				tags: ["h1"],
				tooltip: "Header 1"
			},
			...
			h2: {
				...
				className: "h2",
				command: ($.browser.msie || $.browser.opera || $.browser.webkit )	? "FormatBlock" : "heading",
				"arguments": ($.browser.msie || $.browser.opera || $.browser.webkit) ? "<h2>" : "h2",
				tags: ["h2"],
				tooltip: "Header 2"
			},
			...
			h3: {
				...
				className: "h3",
				command: ($.browser.msie || $.browser.opera || $.browser.webkit ) ? "FormatBlock" : "heading",
				"arguments": ($.browser.msie || $.browser.opera || $.browser.webkit) ? "<h3>" : "h3",
				tags: ["h3"],
				tooltip: "Header 3"
			},
...
html: '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body style="margin:0;">INITIAL_CONTENT</body></html>',
			...
			formWidth: 440,
			iFrameClass: null,
			initialContent: "<h1 class='placeholder'>Start Writing Here</h1>",
		...
		this.ui.appendItem = function (name, control) {
			...
			return $('<li role="menuitem" unselectable="on"><i class="icon '+className.toLowerCase()+'"></i><span>' + className + "</span></li>")
				.addClass(className)
				.attr("title", tooltip)
		...
		this.init = function (element, options) {
			...
			this.editor = $(window.location.protocol === "https:" ? '<iframe src="javascript:false;" width="100%" height="100%"></iframe>' : "<iframe></iframe>").attr({ "frameborder" : "0", width : "100%" , height : "100%" });
		...
		this.ui.initFrame = function () {
			...
			$(self.editorDoc).bind("click.wysiwyg", function (event) {
				$(self.editorDoc.body).find('.placeholder').removeAttr("class");
